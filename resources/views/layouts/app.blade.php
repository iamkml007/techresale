...
<section class="hero">
    <div class="hero-content">
        <h1>Buy & Sell <span class="highlight">Premium Tech</span><br>Second Hand Products</h1>
        <p>Quality tested • 6 months warranty • Up to 60% off • Free shipping</p>
        <div class="hero-buttons">
            <a href="#" class="btn-primary">Shop Now</a>
            <a href="#" class="btn-secondary">Sell Your Device</a>
        </div>
    </div>
</section>
...
<section class="seller-section">
    <div class="seller-content">
        ...
        <p style="opacity: 0.95">Get instant quote and get paid within 24 hours</p>
        <div class="seller-steps">
            <div class="step">
                <div class="step-number">1</div>
                <h3>Describe Device</h3>
                <p>Tell us about your device condition</p>
            </div>
            <div class="step">
                <div class="step-number">2</div>
                <h3>Get Quote</h3>
                <p>Receive instant price offer</p>
            </div>
            <div class="step">
                <div class="step-number">3</div>
                <h3>Ship & Get Paid</h3>
                <p>Free shipping, instant payment</p>
            </div>
        </div>
...
<section class="testimonials">
    ...
    <div class="testimonials-grid">
        <div class="testimonial-card">
            ...
            <p>"Got an iPhone 13 at 40% off. Quality is like new! Highly recommend TechResale."</p>
        </div>
        <div class="testimonial-card">
            <div class="testimonial-avatar">
                <i class="fas fa-user"></i>
            ...
            <h3>Priya Patel</h3>
            <div class="product-rating">★★★★★</div>
            <p>"Sold my PS4 within 2 days. Process was super smooth and payment was instant."</p>
        </div>
        <div class="testimonial-card">
            <div class="testimonial-avatar">
                <i class="fas fa-user"></i>
            ...
            <h3>Amit Kumar</h3>
            <div class="product-rating">★★★★☆</div>
            <p>"Great platform for second-hand tech. Customer support is very responsive."</p>
        </div>
    </div>
</section>
