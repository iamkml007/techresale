              ...
              <div class="col-lg-12">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"></div><strong>View Category</strong>
                        <div class="col-lg-12">
                          ...
                          <table class="table table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><img src="{{asset('categories/'.$cat->image)}}" style="width: 100px; height: 50px;" alt="" srcset=""></td>
                                <td><a href="{{ route('edit-category',$cat->id) }}" class="btn btn-success">Edit</a></td>
                                <td><a href="{{ route('delete-category',$cat->id) }}" class="btn btn-danger">Delete</a></td>
                              </tr>
                              @endforeach
                            </tbody>
                          </table>
