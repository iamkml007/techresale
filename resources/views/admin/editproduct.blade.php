          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="block-body">
                    <form class="form-horizontal" method="POST" action="{{ route('update-product',$product->id) }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="slug" name="slug" value="{{ $product->slug }}"  placeholder="Enter Slug Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="description" class="col-sm-3 form-control-label">Description</label>
                        <div class="col-sm-9">
                          <textarea type="text" id="description" class="form-control"  name="description" placeholder="Enter Product Description">{{ $product->description }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="specifications" class="col-sm-3 form-control-label">Specifications</label>
                        <div class="col-sm-9">
                          <textarea type="text" id="specifications" class="form-control" name="specifications" placeholder="Enter Product Specifications">{{ $product->specifications }}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="price" class="col-sm-3 form-control-label">Price</label>
                        <div class="col-sm-9">
                          <input type="number" id="price" class="form-control" name="price" value="{{ $product->price }}"  placeholder="Enter Product Price">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="compare_price" class="col-sm-3 form-control-label">Compare Price</label>
                        <div class="col-sm-9">
                          <input type="number" id="compare_price" class="form-control" name="compare_price" value="{{ $product->compare_price }}"  placeholder="Enter Product Compare Price">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="stock" class="col-sm-3 form-control-label">Stock</label>
                        <div class="col-sm-9">
                          <input type="number" id="stock" class="form-control" name="stock" value="{{ $product->stock }}"  placeholder="Enter Product Stock">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select name="category_id" class="form-control mb-3">
                            ...
                            @foreach($categories as $cat)
                                <option value="{{ $cat->id }}" 
                                    {{ old('product->category_id', $product->category_id ?? '') == $cat->id ? 'selected' : '' }}>
                                    {{ $cat->name }}
                                </option>
                            @endforeach
                        </select>
               ...
               {{ old('is_published', $product->is_published ?? false) ? 'checked' : '' }} class="form-checkbox" name="is_published" >
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select name="condition" id="condition" class="form-control mb-3">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                         <select name="grade" id="grade" class="form-control mb-3">
                            <option value="">Select Grade</option>
                            <option value="A" {{ old('grade', $product->grade ?? '') == 'A' ? 'selected' : '' }}>A - Like New</option>
                            <option value="B" {{ old('grade', $product->grade ?? '') == 'B' ? 'selected' : '' }}>B - Very Good</option>
                            <option value="C" {{ old('grade', $product->grade ?? '') == 'C' ? 'selected' : '' }}>C - Good</option>
                        </select>
                        </div>
                      </div>
                      <div class="form-group row">
                              ...
                              <div class="thumbnail-grid">
                                  @foreach($product->all_image_urls as $index => $imageUrl)
                                      <div class="thumbnail {{ $index == 0 ? 'active' : '' }}" 
                                          ...
                                          <img src="{{ $imageUrl }}" style="width: 100px; height: 50px;" alt="Thumbnail {{ $index + 1 }}">
                                      </div>
                                  @endforeach
                              </div>
                          @endif
                          <!-- <img src="{{asset('products/'.$product->image)}}" style="width: 100px; height: 50px;" alt="" srcset=""> -->
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" value="{{ $product->battery_health }}"  id="battery_health" name="battery_health" placeholder="e.g., 85%">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="accessories" class="col-sm-3 form-control-label">Accessories Included</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="accessories" value="{{ $product->accessories_included }}" name="accessories_included" placeholder="Charger, Cable, etc.">
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
