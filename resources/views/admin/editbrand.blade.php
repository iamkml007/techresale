  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <li class="active"><a href="#brand" aria-expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Brand</a>
              ...
              <div class="col-lg-12">
                <div class="block">
                  ...
                  <div class="block-body">
                    <form class="form-horizontal" method="POST" action="{{ route('update-brand',$brand->id) }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Image</label>
                        <div class="col-sm-9">
                          <img src="{{asset('brands/'.$brand->image)}}" style="width: 100px; height: 50px;" alt="" srcset="">
                      </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Description</label>
                        <div class="col-sm-9">
                          <textarea type="text" class="form-control" name="description" placeholder="Enter Brand Description">{{ $brand->description }}</textarea>
                        </div>
                      </div>
                      <div class="line"></div>
                      <div class="form-group row">
