                ...
                <div class="block margin-bottom-sm">
                  <!-- <div class="search-panel">
                    <div class="search-inner d-flex align-items-center ">
                      <form id="searchForm" action="{{ route('search-order') }}" method="POST">
                        @csrf
                        <div class="form-group">
                          ...
                          <button type="submit" class="submit btn btn-primary">Search</button>
                            <a href="{{ route('view-all-product') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                      </form>
                    </div>
                  </div> -->
                  <div class="title"><strong>View All Orders</strong></div>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($order->product->images)
                                    @php
                                        $images = is_array($order->product->images) 
                                            ? $order->product->images 
                                            : json_decode($order->product->images, true);
                                        $firstImage = $images[0] ?? null;
                                    @endphp
                                    @if($firstImage)
                                        <img style="width: 50px;" src="{{ asset($firstImage) }}" alt="Product Image">
                                    @else
                                        <img style="width: 50px;" src="{{ asset('images/no-image.png') }}" alt="No Image">
                                    @endif
                                @else
                                    <img style="width: 50px;" src="{{ asset('images/no-image.png') }}" alt="No Image">
                                @endif
                            ...
                            <td>
                                ...
                                <a href="{{ route('invoice',$order->id)}}" class="btn btn-warning">Download Invoice</a>
                            </td>
                        </tr>
                        @endforeach
                        {{ $orders->links()}}
