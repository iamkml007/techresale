            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="block margin-bottom-sm">
                  <div class="title"><strong>View All Brand</strong></div>
                      ...
                      <tbody>
                        @foreach($brands as $brand)
                              <tr>
                                ...
                                <td><img src="{{asset('brands/'.$brand->image)}}" style="width: 100px; height: 50px;" alt="" srcset=""></td>
                                <td>
                                <a href="{{ route('edit-brand',$brand->id) }}" class="btn btn-success">Edit</a>
