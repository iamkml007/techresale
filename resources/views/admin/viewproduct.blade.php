                ...
                <div class="block margin-bottom-sm">
                  <!-- <div class="search-panel">
                    <div class="search-inner d-flex align-items-center ">
                      <form id="searchForm" action="{{ route('search-product') }}" method="POST">
                        @csrf
                        <div class="form-group">
                  ...
                  <div class="title"><strong>View All Product</strong></div>
                        ...
                        @foreach($products as $product)
                              <tr>
                                ...
                                @if($product->first_image)
                                  <td><img src="{{asset($product->first_image)}}" style="width: 100px; height: 100px;" alt="{{ $product->name }}" srcset=""></td>
                                @else
                                  <td><img src="{{asset('images/no-image.jpg')}}" style="width: 100px; height: 100px;" alt="No image" srcset=""></td>
                                @endif
                                <td>
